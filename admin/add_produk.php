<?php
  ...
  $sql = "INSERT INTO produk (nama_produk,harga,deskripsi1,deskripsi2,kategori,stok,gambar)
  VALUES (
    '$nama_produk',
    '$harga',
    '$deskripsi1',
   ...
   if ($query) {
    ...
    echo "<script>alert('Data Produk gagal di tambahkan');</script>";
    }
  }
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-danger">
                  ...
                  <p class="card-category">Isilah Data Produk Dengan Lengkap</p>
                </div>
                <div class="card-body">
                  ...
                  <form action="add_produk.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-md-4">
                        <label >Gambar: </label>  
                        <input type="file" name="gambar" class="dropify" accept="image/*" width="40%" height="40%" required /> 
                      </div><br>
                      <div class="col-md-12">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="desk1" rows="5"></textarea>
                          </div>
                          <div class="form-group">
                            <label class="bmd-label-floating">Deskripsi</label>
                            <textarea class="form-control" name="desk2" rows="5"></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
